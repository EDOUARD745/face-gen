...
class GaussianDiffusion:
    ...
    def _composed_eps(self, x, t, attrs, scales):
        ...
        # Mode hybride : la branche conjointe est conservée et les échelles par
        # attribut ne font qu'AJOUTER un supplément. Le compositionnel pur
        # remplace le conditionnement conjoint par une somme de branches
        # mono-attribut, ce qui casse l'interaction entre attributs (mesuré :
        # genre 86,8 % -> 67,7 %, FID 24,0 -> 56,4).
        base = scales.get("base", 0.0)
        if base:
            keys = keys + ["base"]
            conds = conds + [E(attrs)]
