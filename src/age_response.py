...
def training_support(min_age=18, max_age=70):
...
def main():
    ...
    print(f"Support d'âge réellement vu à l'entraînement : {support}")
    ...
    rows = measure_response(diff, clf, image_size, device, ages, args.per_age,
                            args.guidance_scale, args.batch_size)
    ...
    calib["guidance_scale"] = args.guidance_scale
    ...
    plot(rows, support, args.out_png)
